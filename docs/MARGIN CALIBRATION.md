...
- méthode "*linéaire tronquée*" : version tronquée de la pseudo-distance *linéaire* permettant d'obtenir des poids avec des amplitudes non négatives et d'amplitudes raisonnables. La méthode est donnée par : $G(r) = \frac{1}{2}(r-1)^{2}$ avec $L \leq r \geq U$
